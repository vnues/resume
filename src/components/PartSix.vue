<template>
  <div :class="partSix">
    ...
    <p class="font-small"><span class="font-bold">前端：</span>HTML/HTML5、CSS/CSS3、JS/ES6、jQuery、Vue、react</p>
    <p class="font-small"><span class="font-bold">后端：</span>Node</p>
    <p class="font-small"><span class="font-bold">数据库：</span>MongoDB.Mongoose</p>
  </div>
</template>
